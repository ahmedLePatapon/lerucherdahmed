...
export function ContactDPO() {
    return (
        <div className="rounded-2xl border border-surface-border border-gray-200 p-8 bg-white">
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8">
                ...
                <a
                    className="flex items-center justify-center rounded-lg h-12 bg-primary px-6 text-background-dark text-sm font-bold hover:bg-[#ffe04d] transition-all transform hover:-translate-y-0.5"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 border-t border-surface-border border-gray-200 pt-6">
                <div className="flex flex-col gap-1 py-2 pr-2 border-r border-transparent md:border-surface-border md:border-gray-200">
