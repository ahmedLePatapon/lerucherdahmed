        ...
        <div className="rounded-xl bg-white border border-surface-border overflow-hidden">
            <div className="p-6">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-off-white border border-surface-border">
                        <span className="material-symbols-outlined text-primary mt-1">toggle_on</span>
                        <div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-off-white border border-surface-border">
                        <span className="material-symbols-outlined text-gray-400 mt-1">toggle_off</span>
                        <div>
            ...
            <div className="bg-primary/5 px-6 py-4 border-t border-surface-border flex justify-between items-center">
