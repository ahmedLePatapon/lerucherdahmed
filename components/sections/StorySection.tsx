            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="flex flex-col gap-6 lg:order-2">
                        ...
                        <Link href="/rencontre/histoire-passion" className="inline-flex items-center text-text-main hover:text-primary-dark transition-colors group w-fit font-bold decoration-2 underline-offset-4">
